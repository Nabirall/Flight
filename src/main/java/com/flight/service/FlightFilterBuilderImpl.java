...
import com.flight.model.Segment;
...
@Override
public FlightFilterBuilder filterDepartureEarlierNow() {
...
@Override
public FlightFilterBuilder filterTotalTimeSpentOnTheGroundMoreThanTwoHours() {
    flights.removeIf(flight -> {
